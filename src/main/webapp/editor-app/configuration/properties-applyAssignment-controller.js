 ...
 * Assignment
 */
var ApplyKisBpmAssignmentCtrl = [ '$scope', '$modal', function($scope, $modal) {

    // Config for the modal window
    var opts = {
        template:  'editor-app/configuration/properties/applyAssignment-popup.html?version=' + Date.now(),
        scope: $scope
    };
...
var ApplyKisBpmAssignmentPopupCtrl = [ '$scope','$http', function($scope,$http) {
