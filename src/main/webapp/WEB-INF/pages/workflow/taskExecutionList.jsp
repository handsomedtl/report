...
<div class="container">
    	<div class="main_container right_col">	
            <form name="" id="form1" class="form-horizontal form-label-left" method="post">
            	<div class="row"> 
            	...
            	<div class="col-md-12 col-sm-12 col-xs-12">	
                    ...
                    <!--		<div class="DTTT_container">-->
                        <div class="add-btn-plr">
                        	<button type="button" class="btn btn-info btn-xs" onclick="selectWorkflow()">新 增</button>
                        <!--<ul class="nav navbar-right ico-toolbtn">
                        <li>
                            <a type="button" href="javascript:selectWorkflow()" title="新增">
                       ...
                       <!--  <li>
                        ...
                        <!--</ul>-->
                        	<div class="clearfix"></div>
                                 ...
                                 <!-- <a type="button" href="javascript:selectWorkflow()" title="流程选择" url=""
                                    class="DTTT_button DTTT_button_update">新增</a> -->
                                <!-- <a href="#" class="DTTT_button DTTT_button_update">删除</a>  -->
                                    
                    <!--		</div>-->
                    <asiainfo:table id="mytable" paging="true" actionUrl="getProcessTradeExecution.jhtml"
                        ...
                        <asiainfo:td title="发起时间" field="startDate" render="(new Date(data)).format(\"yyyy-MM-dd\")"></asiainfo:td>
                        <asiainfo:td title="申请内容" field="bizSummary"></asiainfo:td>
                        <asiainfo:td title="状态" field="processState" render="processState(data);"></asiainfo:td>
                        <asiainfo:td title="当前节点" field="currentNode"></asiainfo:td>
                        <asiainfo:td title="当前负责人" field="currentStaffName"></asiainfo:td>
                        <asiainfo:td title="操作" field="processInstanceId" render="gettype(data, type, full);"></asiainfo:td>
...
<script type="text/javascript">
	var gettype = function(data, type, full) {
		if (data == '0') {
			return "<a  data-addtab=\"update\" href=\"javascript:updateapplydata('"+full.processId+"');\" url=\"${ctx}/workflow/showStartFrom.jhtml?processId=" + full.processId +"\">修改</a>";
		} else if (data != '0') {
			 ...
			 return "<a   href=\"javascript:workfolwInfo('"+data+"','"+full.processId+"');\" url=\"${ctx}/workflow/showStartFrom.jhtml?processId=" + full.processId +"\">查看当前流程</a>";
		}
	}
	var workfolwInfo = function(processInstanceId,processId){
		var url = '${ctx}/workflow/processDetail.jhtml?processInstanceId='+ processInstanceId +'&processId='+processId;
		addTabByGeneLink('add', '流程详情', url, 'mytable');
		/*parent.Addtabs.add({
			id : 'add',
			title : '流程详情',
			url : '${ctx}/workflow/processDetail.jhtml?processInstanceId='+ processInstanceId +'&processId='+processId,
			ajax : false,
			callback : function(){
