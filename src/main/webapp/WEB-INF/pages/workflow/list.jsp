...
<link href="/resources/gentelella/css/bootstrap.min.css"
	rel="stylesheet">

<link href="/resources/gentelella/fonts/css/font-awesome.min.css"
	rel="stylesheet">
<link href="/resources/gentelella/css/animate.min.css" rel="stylesheet">

<!-- Custom styling plus plugins -->
<link href="/resources/gentelella/css/custom.css" rel="stylesheet">
<link rel="stylesheet" type="text/css"
	href="/resources/gentelella/css/maps/jquery-jvectormap-2.0.1.css" />
<link href="/resources/gentelella/css/icheck/flat/green.css"
	rel="stylesheet" />
<link href="/resources/gentelella/css/floatexamples.css"
	rel="stylesheet" type="text/css" />

<script src="/resources/gentelella/js/jquery.min.js"></script>
<script src="/resources/gentelella/js/nprogress.js"></script>
<script>
        NProgress.start();
    </script>
...
<body class="nav-md">
				...
				<div class="left_col scroll-view">
					...
					<div class="profile">
						<div class="profile_pic">
							<img src="/resources/gentelella/images/img.jpg" alt="..."
					...
					<ul class="nav navbar-nav navbar-right">
						<li class=""><a href="javascript:;"
							...
							aria-expanded="false"> <img
								src="/resources/gentelella/images/img.jpg" alt="">John Doe
						...
						<li role="presentation" class="dropdown"><a
							...
							<ul id="menu1"
								...
								<li><a> <span class="image"> <img
											src="/resources/gentelella/images/img.jpg"
											alt="Profile Image" />
						...
						<div class="x_panel tile fixed_height_320 overflow_hidden">
							...
							<div class="x_content">
								...
								<table class="" style="width: 100%">
									...
									<tr>
										<td><canvas id="canvas1" height="140" width="140"
										...
										<div class="row">
											<div class="col-sm-4">
												<div class="weather-icon">
													<span> <canvas height="84" width="84"
										...
										<div class="row weather-days">
											<div class="col-sm-2">
												<div class="daily-weather">
													...
													<span> <canvas id="clear-day" width="32" height="32">
														</canvas>
	...
	<script src="/resources/gentelella/js/bootstrap.min.js"></script>

	<!-- gauge js -->
	<script type="text/javascript"
		src="/resources/gentelella/js/gauge/gauge.min.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/gauge/gauge_demo.js"></script>
	<!-- chart js -->
	<script src="/resources/gentelella/js/chartjs/chart.min.js"></script>
	<!-- bootstrap progress js -->
	<script
		src="/resources/gentelella/js/progressbar/bootstrap-progressbar.min.js"></script>
	<script
		src="/resources/gentelella/js/nicescroll/jquery.nicescroll.min.js"></script>
	<!-- icheck -->
	<script src="/resources/gentelella/js/icheck/icheck.min.js"></script>
	<!-- daterangepicker -->
	<script type="text/javascript"
		src="/resources/gentelella/js/moment.min.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/datepicker/daterangepicker.js"></script>

	<script src="/resources/gentelella/js/custom.js"></script>

	<!-- flot js -->
	<!--[if lte IE 8]><script type="text/javascript" src="js/excanvas.min.js"></script><![endif]-->
	<script type="text/javascript"
		src="/resources/gentelella/js/flot/jquery.flot.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/flot/jquery.flot.pie.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/flot/jquery.flot.orderBars.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/flot/jquery.flot.time.min.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/flot/date.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/flot/jquery.flot.spline.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/flot/jquery.flot.stack.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/flot/curvedLines.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/flot/jquery.flot.resize.js"></script>
	<script>
	...
	<!-- worldmap -->
	<script type="text/javascript"
		src="/resources/gentelella/js/maps/jquery-jvectormap-2.0.1.min.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/maps/gdp-data.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/maps/jquery-jvectormap-world-mill-en.js"></script>
	<script type="text/javascript"
		src="/resources/gentelella/js/maps/jquery-jvectormap-us-aea-en.js"></script>
	<script>
        $(function () {
	...
	<!-- skycons -->
	<script src="/resources/gentelella/js/skycons/skycons.js"></script>
	<script>
